...
public struct ScNotificationHeader
{
    ...
    /// <summary>
    /// The SCN_* notification Code. Could be <see cref="NppMsg"/> or <see cref="SciMsg"/>.
    /// </summary>
    public uint Code;
}
...
public struct ScNotification
{
    ...
    public nint TextPointer;          /* SCN_MODIFIED, SCN_USERLISTSELECTION, SCN_AUTOCSELECTION, SCN_URIDROPPED */
    public int Length;                  /* SCN_MODIFIED */
    public int LinesAdded;              /* SCN_MODIFIED */
    public int Message;                 /* SCN_MACRORECORD */
    public nint wParam;               /* SCN_MACRORECORD */
    public nint lParam;               /* SCN_MACRORECORD */
...
public class TextToFind : IDisposable
{
    ...
    private nint _ptrSciTextToFind;
    ...
    public nint NativePointer { get { _initNativeStruct(); return _ptrSciTextToFind; } }
    ...
    {
        if (_sciTextToFind.lpstrText != nint.Zero) Marshal.FreeHGlobal(_sciTextToFind.lpstrText);
    }
    ...
    public void Dispose()
    {
        ...
        {
            _freeNativeString();
            if (_ptrSciTextToFind != nint.Zero) Marshal.FreeHGlobal(_ptrSciTextToFind);
            _disposed = true;
        }
    }
